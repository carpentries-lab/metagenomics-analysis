...
>
> Chepiche wants to know how many contigs and how many scaffolds results for the assembly. Use `contigs.fasta `
>  and `scaffolds.fasta ` files and sort the commands to create correct code lines. 
