...
$ kraken2 --db kraken-db --threads 8 --paired --gzip-compressed JP4D_R1.trim.fastq.gz JP4D_R2.trim.fastq.gz --output TAXONOMY_READS/JP4D.kraken --report TAXONOMY_READS/JP4D.report
~~~
{: .language-bash}
